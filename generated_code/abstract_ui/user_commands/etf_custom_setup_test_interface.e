...
feature {NONE} -- Initialization
	...
	make(an_etf_cmd_name: STRING; etf_cmd_args: TUPLE; an_etf_cmd_container: ETF_ABSTRACT_UI_INTERFACE)
		do
			...
			then
				out := "custom_setup_test(" + etf_event_argument_out("custom_setup_test", "dimension", dimension) + "," + etf_event_argument_out("custom_setup_test", "ships", ships) + "," + etf_event_argument_out("custom_setup_test", "max_shots", max_shots) + "," + etf_event_argument_out("custom_setup_test", "num_bombs", num_bombs) + ")"
			else
				etf_cmd_error := True
			end
		end
...
feature -- command precondition 
	custom_setup_test_precond(dimension: INTEGER_64 ; ships: INTEGER_64 ; max_shots: INTEGER_64 ; num_bombs: INTEGER_64): BOOLEAN
		do  
			Result := 
